...
(() => {
  ...
  function boot(runtime, doc = document) {
    ...
    /* ReelOrder: the runtime already adopted the template parsed from the live DOM
       above; this re-fetched the whole document on every page view only to hand the
       editor a hot-reloadable copy. Removed in production - halves HTML bytes per view. */
    const dc = doc.querySelector("x-dc");
